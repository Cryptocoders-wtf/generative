<template>
  <div class="mx-auto max-w-3xl p-2 text-left">
    <p class="mb-2">Images of this NFT collection are dynamically generated by the smart contract on the Ethereum blockchain,
      using the world first vector-based on-chain font.</p>
