  ...
  <div class="home">
    ...
    <div class="flex justify-center">
        <div class="mt-2">
          ...
          <div class="mx-8">
              {{ token_obj.data.name }}
               <div v-if="token_obj.data.image == ''" class="w-96 h-96 border-2 text-center align-middle">
                <img src="@/assets/preload.gif" class="w-10 h-10 mx-auto align-middle" />
               </div>
               <div v-else>
                <img :src="token_obj.data.image" class="w-96 h-96 border-2" />
                </div>
        ...
        <div>
          <h2>address</h2>
          <p>{{ token_obj.token_id }}</p>
          <h3>price {{ token_obj.price }}</h3>
